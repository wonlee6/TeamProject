		...
		<div class="wrap">
			<div class="form-wrap">
				...
				<form action="${pageContext.request.contextPath}/member/login.do"
					...
					<label for="inp" class="inp"> <input type="text"
						class="inp" placeholder="&nbsp;" id="id" name="id"> <span
						class="label">아이디</span> <span class="focus-bg"></span>
					</label> <label for="inp" class="inp"> <input type="password"
						class="inp" placeholder="&nbsp;" id="pass" name="pass"> <span
						class="label">비밀번호</span> <span class="focus-bg"></span>
					</label>
